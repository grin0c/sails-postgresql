  ...
  var adapter = {
    ...
    registerConnection: function(connection, collections, cb) {
      ...
      _.each(_.keys(collections), function(coll) {
        ...
        if(!_schema._columnsMap) _schema._columnsMap = {};
        ...
        _.each(_.keys(_schema.attributes), function(attr) {
          if (_schema.attributes[attr].columnName && _schema.attributes[attr].columnName != attr) {
            _schema._columnsMap[_schema.attributes[attr].columnName] = attr;
          }
        });
